{
  ...
  outputs = { self, nixpkgs, home-manager, ... }@inputs:
    ...
    {
      nixosConfigurations = {
        suzu = mkSystem { hostname = "suzu"; };
        gohei = mkSystem { hostname = "gohei"; };
        omamori  = mkSystem { hostname = "omamori"; system = "aarch64"; bootMode = "uboot"; };
        ofuda = mkSystem { hostname = "ofuda"; bootMode = "grub-bios"; };
      };
    };
}
