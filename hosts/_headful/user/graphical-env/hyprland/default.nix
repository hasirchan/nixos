{ config, lib, pkgs, osConfig, ... }: {
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      in [
        ", Print, exec, grimblast copysave output ~/Pictures/Screenshots/${hostName}_$(date +'%Y-%m-%d_%H-%M-%S').png"
        "SHIFT, Print, exec, grimblast copysave area ~/Pictures/Screenshots/${hostName}_$(date +'%Y-%m-%d_%H-%M-%S').png"
      ];
