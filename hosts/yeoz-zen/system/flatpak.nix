{ config, lib, pkgs, ... } :
{
  ...
  fileSystems."/var/lib/flatpak" = {
    ...
    fsType = "btrfs";
    options = ["subvol=flatpak/@root-var-lib-flatpak" "compress=zstd" "noatime" ];
  };
  fileSystems."/home/saya/.var" = {
    device = "/dev/disk/by-uuid/d8aaee03-036d-4c1a-a553-c67b0324ff71";
    fsType = "btrfs";
    options = ["subvol=flatpak/@home-saya-dotvar" "compress=zstd" "noatime" ];
  };
  fileSystems."/home/saya/.local/share/flatpak" = {
    device = "/dev/disk/by-uuid/d8aaee03-036d-4c1a-a553-c67b0324ff71";
    fsType = "btrfs";
    options = ["subvol=flatpak/@home-saya-dotlocal-share-flatpak" "compress=zstd" "noatime" ];
  };
  systemd.services = {
